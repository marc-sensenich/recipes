...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c0972b9dfacc0d8650915b937bcea6187a2d92e8ac6d1a16be36fdc0da6e5585.js',function(){input.required=false;search();});}
