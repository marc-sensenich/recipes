...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0822d170ecaaf724dcd876cd9699446a7588cf500a427e867b68efe31f6e2e19.js',function(){input.required=false;search();});}
