...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fc47c43dca7ebe11e072fd24c6016632a79a91c3e6ff97728014080bf71cacfb.js',function(){input.required=false;search();});}
