...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f34fe5e26e893e0a5c896894c5309d03e7a844d39bb697cbecab4a05710c0e35.js',function(){input.required=false;search();});}
